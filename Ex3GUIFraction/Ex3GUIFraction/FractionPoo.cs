...
namespace Ex3GUIFraction
{
    public partial class FractionPoo : Form
    {
        ...
        {
            Fraction fraction1 = new Fraction(Convert.ToInt32(txbFrac1Num.Text), Convert.ToInt32(txbFrac1Den.Text));
            Fraction fraction2 = new Fraction(Convert.ToInt32(txbFrac2Num.Text), Convert.ToInt32(txbFrac2Den.Text), new BeautifierInterfaceParenthesis());
            Fraction fraction3 = new Fraction(Convert.ToInt32(txbFrac3Num.Text), Convert.ToInt32(txbFrac3Den.Text), new BeautifierInterfaceLatex());
